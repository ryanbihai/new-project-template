...
**AI 请注意：在每次会话开始时，必须先读取 `进度跟踪.md` 以掌握当前进度。随后根据用户具体需求，按需读取 `docs/` 下的相关规范文档（如涉及 UI 修改必读 `4_UI规范.md`，涉及数据必读 `5_数据结构.md`）。**
...
- **技术与规范**:
  - `docs/3_技术栈.md`: 锁定的技术栈版本（Next.js 14, Tailwind, Shadcn UI）。
